...
interface TestProps {
  navigation: any; // You can replace 'any' with the actual type
}
...
class Test extends Component<TestProps, TestState> {
    ...
    async onSalesforceLogin() {
        // oauth.authenticate().then((res)=>{
        //     console.log("REESPONSE SALESFORCE",res)
        //     syncData()
        //     this.setState({ loggedIn: true })
        // }).catch((err)=>{
        //     console.log("onSalesforceLogin",err)
        // })        
        console.log("ON LOGIN OUTSIDEE =>")
     ...
     */
    async getSalesforceAccessToken(azureAccessToken:any) {
        try {
